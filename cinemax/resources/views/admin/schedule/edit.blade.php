                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('schedule.update', $schedule->id) }}">
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="start" type="text" class="form-control{{ $errors->has('start') ? ' is-invalid' : '' }}" name="start" value="{{ $schedule->start }}" required autofocus>
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="end" type="text" class="form-control{{ $errors->has('end') ? ' is-invalid' : '' }}" name="end" value="{{ $schedule->end }}" required autofocus>
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ $schedule->price }}" required autofocus>
